...
mean_data_0.5 <- read.table("data/LRC/summary_data/LRC_mig_0.5_means_ind.tsv", 
                             header = TRUE)
mean_data_0.9 <- read.table("data/LRC/summary_data/LRC_mig_0.9_means_ind.tsv", 
                            header = TRUE)
mean_data_0.95 <- read.table("data/LRC/summary_data/LRC_mig_0.95_means_ind.tsv", 
                            header = TRUE)
...
ess_0.9 <- calculate_ess(mean_data_0.9, model = "LRC")
ess_0.95 <- calculate_ess(mean_data_0.95, model = "LRC")

ess <- rbind(ess_0.01, ess_0.05, ess_0.1, ess_0.5, ess_0.9, ess_0.95)
